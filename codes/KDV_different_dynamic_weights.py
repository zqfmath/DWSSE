...
class DWPMR:
    ...
    def identification(self, t, x, u, u_layers, pde_layers):
        ...
        self.ide_u_predict = self.ide_net_u(self.to_feed_t, self.to_feed_x)[0]
        ...
        # for regularization
        self.ide_regular_predict = self.ide_net_u(self.to_feed_t, self.to_feed_x)[1]
...
if __name__ == "__main__":
    ...
    # Doman bounds
    lower_bound = np.array([0.0, -20.0])
    upper_bound = np.array([40.0, 20.0])

    # Load Data from data files
    data_ide = scipy.io.loadmat('../Data/KdV_sine.mat')
